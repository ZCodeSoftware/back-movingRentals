...
export function generateUserBookingRejectedEn(
  ...
  const subject = `Reservation with PAYMENT REJECTED #${bookingNumber} - Contact Us to Generate New Payment Link`;
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .alert-box p { margin: 5px 0; color: #721c24; }
        .footer { 
          margin-top: 30px; 
          padding-top: 20px; 
          text-align: center; 
    ...
    <body>
      <div class="email-container">
        <h1 style="color: #dc3545;">Reservation with PAYMENT REJECTED ❌</h1>
        <p>Hello <strong>${customerFullName}</strong>,</p>

        <div class="alert-box">
          <p><strong>❌ PAYMENT REJECTED – CONTACT US TO GENERATE A NEW PAYMENT LINK</strong></p>
          <p>The payment for your reservation was rejected. Please contact us to generate a new payment link and complete your reservation.</p>
        </div>
        ...
        <div class="section">
          ...
          <p><strong>Status:</strong> <span style="color: #dc3545; font-weight: bold;">PAYMENT REJECTED</span></p>
        </div>
        ...
        <div class="section">
          ...
          <div class="item-details" style="background-color: #ffe6e6; border-left-color: #dc3545;">
        ...
        <div class="section">
          <h2>📞 Contact Us to Generate a New Payment Link</h2>
          <div class="item-details" style="background-color: #e8f5e9; border-left-color: #4caf50;">
            <p style="font-size: 16px; margin-bottom: 15px;"><strong>To generate a new payment link and complete your reservation, contact us via:</strong></p>
          ...
          <p style="margin-top: 15px; font-size: 14px; color: #666;">We're here to help you complete your reservation successfully.</p>
        </div>
